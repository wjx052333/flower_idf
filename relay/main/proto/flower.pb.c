...
PB_BIND(FLOWER_METRIC, flower_metric_t, AUTO)
...
PB_BIND(FLOWER_SNAPSHOT_COMMAND, flower_snapshot_command_t, 2)


PB_BIND(FLOWER_SNAPSHOT_RESPONSE, flower_snapshot_response_t, AUTO)
